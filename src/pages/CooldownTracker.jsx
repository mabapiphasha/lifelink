    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <nav className="bg-purple-900 text-white p-4 shadow-lg">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <span className="text-purple-200 text-sm font-medium">56-Day Cooldown Tracker</span>
          <Link to="/hospital" className="text-sm hover:text-purple-200 transition-colors">← Hospital Dashboard</Link>
        </div>
      </nav>
